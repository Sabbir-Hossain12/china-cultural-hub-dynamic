            ...
            <div class="col-lg-6">
                ...
                <div class="about-us-content-gold">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ $collision->title ?? '' }} </h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">{{ $collision->short_desc ?? '' }}</p>
                    </div>
                    <!-- Section Title End -->
                    ...
                    <div class="about-us-footer-gold wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="about-us-btn-gold">
                            <a href="{{ route('collision') }}" class="btn-default">more about Collision</a>
                        </div>
                        <!-- About Us Button End -->
                    </div>
                    <!-- About Us Footer End -->
            ...
            <div class="col-lg-6">
                ...
                <div class="about-us-images-gold">
                    ...
                    <div class="about-image-counter-gold">
                        @foreach(json_decode($collision->images, true) as $key => $img)
                    ...
                    @php
                        $images = json_decode($collision->images, true);
                    @endphp
