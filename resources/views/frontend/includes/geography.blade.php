<!-- The Geographical Environment and Chinese Culture Start-->
<div class="about-us-gold" id="about-us">
    <div class="container">
            ...
            <div class="col-lg-6">
                ...
                <div class="about-us-images-gold">
                    ...
                    <div class="about-image-counter-gold">
                        @foreach(json_decode($geography->images, true) as $key => $img)
                    ...
                    @php
                        $images = json_decode($geography->images, true);
                    @endphp
            ...
            <div class="col-lg-6">
                ...
                <div class="about-us-content-gold">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ $geography->title ?? '' }}</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">{{ $geography->short_desc ?? '' }}</p>
                    </div>
                    <!-- Section Title End -->
                    ...
                    <div class="about-us-footer-gold wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="about-us-btn-gold">
                            <a href="{{ route('geography') }}" class="btn-default">more about Culture</a>
                        </div>
                        <!-- About Us Button End -->
                    </div>
                    <!-- About Us Footer End -->
...
<!-- The Geographical Environment and Chinese Culture End -->
