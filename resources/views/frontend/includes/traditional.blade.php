<!-- Chinese Traditional Thoughts Start-->
<div class="about-us-gold" id="about-us2">
    <div class="container">
            ...
            <div class="col-lg-6">
                ...
                <div class="about-us-content-gold">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ $tradition->title ?? '' }} </h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">{{ $tradition->short_desc ?? '' }}</p>
                    </div>
                    <!-- Section Title End -->
                    ...
                    <div class="about-us-footer-gold wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="about-us-btn-gold">
                            <a href="{{ route('tradition') }}" class="btn-default">more about Tradition</a>
                        </div>
                        <!-- About Us Button End -->
                    </div>
                    <!-- About Us Footer End -->
            ...
            <div class="col-lg-6">
                ...
                <div class="about-us-images-gold">
                    ...
                    <div class="about-image-counter-gold">
                        @foreach(json_decode($tradition->images, true) as $key => $img)
                    ...
                    @php
                        $images = json_decode($tradition->images, true);
                    @endphp
...
<!-- Chinese Traditional Thoughts End -->
