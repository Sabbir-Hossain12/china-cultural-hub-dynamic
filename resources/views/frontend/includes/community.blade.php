    ...
    <div class="container">
        <div class="row section-row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title-center">
                    ...
                    <h2 class="text-anime-style-3" data-cursor="-opaque">{{ $community->title ?? '' }}</h2>
                </div>
                <!-- Section Title End -->
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="our-features-list-gold">
                    ...
                    <div class="our-features-item-gold">
                        ...
                        @isset($community->image_1)
                            <div class="our-features-image-gold">
                                <figure class="image-anime reveal">
                                    <img src="{{ asset($community->image_1) }}" alt="">
                                </figure>
                            </div>
                        @endisset
                    ...
                    <div class="our-features-item-gold">
                        <!-- Our Features Image Start -->
                        @isset($community->image_2)
                            <div class="our-features-image-gold">
                                <figure class="image-anime reveal">
                                    <img src="{{ asset($community->image_2) }}" alt="">
                                </figure>
                            </div>
                        @endisset
                        <!-- Our Features Image End -->
                    ...
                    <div class="our-features-item-gold">
                        <!-- Our Features Image Start -->
                        @isset($community->image_3)
                            <div class="our-features-image-gold">
                                <figure class="image-anime reveal">
                                    <img src="{{ asset($community->image_3) }}" alt="">
                                </figure>
                            </div>
                        @endisset
                        <!-- Our Features Image End -->
        ...
        <div class="about-us-footer-gold wow fadeInUp justify-content-center" data-wow-delay="0.8s">
            ...
            <div class="about-us-btn-gold">
                <a href="{{ route('community') }}" class="btn-default">more about Community</a>
            </div>
            <!-- About Us Button End -->
        </div>
        <!-- About Us Footer End -->
