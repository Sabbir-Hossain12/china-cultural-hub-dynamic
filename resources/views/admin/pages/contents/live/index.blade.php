...
@section('content')
    {{--    Form Starts--}}
    @if($live)
        <form method="post" action="{{ route('admin.live.update', $live->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @else
                <form method="post" action="{{ route('admin.live.store') }}" enctype="multipart/form-data">
                    @endif
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center">The Lives of Ancient Chinese</h4>
                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($live->image_1))
                                                        <img src="{{ asset($live->image_1) }}" alt="" class="img-fluid" width="100">
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($live->image_2))
                                                        <img src="{{ asset($live->image_2) }}" alt="" class="img-fluid" width="100">
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($live->image_3))
                                                        <img src="{{ asset($live->image_3) }}" alt="" class="img-fluid" width="100">
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="content_1" name="content_1"
                                                              class="form-control editor"> {{ $live->content_1 ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="content_2" name="content_2"
                                                              class="form-control editor">{{ $live->content_2 ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="content_3" name="content_3"
                                                              class="form-control editor">{{ $live->content_3 ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="long_desc" name="long_desc"
                                                              class="form-control editor">{{ $live->long_desc ?? ''}}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
