...
@section('content')
    ...
    @if($technology)
        <form method="post" action="{{ route('admin.technology.update', $technology->id) }}" enctype="multipart/form-data">
            @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center">China's Contribution to Worlds Science and Technology</h4>
                                </div>
                                            ...
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="title"
                                                           placeholder=""
                                                           id="site_name" value="{{ $technology->title ?? ''}}">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="file" name="images[]"
                                                           id="images" multiple>
                                                    @if(isset($technology->images))
                                                        @forelse(json_decode($technology->images) as $image)
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="video"
                                                           placeholder=""
                                                           id="video" value="{{ $technology->video ?? ''}}">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="short_desc" class="form-label">Short Description</label>
                                                    <textarea id="short_desc" name="short_desc"
                                                              class="form-control">{{ $technology->short_desc ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="long_desc" name="long_desc"
                                                              class="form-control">{{ $technology->long_desc ?? ''}}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
