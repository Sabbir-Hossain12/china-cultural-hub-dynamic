...
@section('content')
    ...
    @if($community)
        <form method="post" action="{{ route('admin.community.update', $community->id) }}" enctype="multipart/form-data">
            @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center">International Community</h4>
                                </div>
                                            ...
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="title"
                                                           placeholder=""
                                                           id="site_name" value="{{ $community->title ?? ''}}">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($community->image_1))
                                                            <img src="{{ asset($community->image_1) }}" alt="" class="img-fluid" width="100">
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($community->image_2))
                                                        <img src="{{ asset($community->image_2) }}" alt="" class="img-fluid" width="100">
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if(isset($community->image_3))
                                                        <img src="{{ asset($community->image_3) }}" alt="" class="img-fluid" width="100">
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="content_1" name="content_1"
                                                              class="form-control editor"> {{ $community->content_1 ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="content_2" name="content_2"
                                                              class="form-control editor">{{ $community->content_2 ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="content_3" name="content_3"
                                                              class="form-control editor">{{ $community->content_3 ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="long_desc" name="long_desc"
                                                              class="form-control editor">{{ $community->long_desc ?? ''}}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
