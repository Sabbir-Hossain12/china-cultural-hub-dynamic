...
@section('content')
    ...
    @if($migration)
        <form method="post" action="{{ route('admin.migration.update', $migration->id) }}" enctype="multipart/form-data">
            @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center">Migration and China's Social Changes</h4>
                                            ...
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="title"
                                                           placeholder=""
                                                           id="site_name" value="{{ $migration->title ?? ''}}">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="file" name="images[]"
                                                           id="images" multiple>
                                                    @if(isset($migration->images))
                                                        @forelse(json_decode($migration->images) as $image)
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="video"
                                                           placeholder=""
                                                           id="video" value="{{ $migration->video ?? ''}}">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="short_desc" class="form-label">Short Description</label>
                                                    <textarea id="short_desc" name="short_desc"
                                                              class="form-control">{{ $migration->short_desc ?? ''}}
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="long_desc" name="long_desc"
                                                              class="form-control">{{ $migration->long_desc ?? ''}}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
