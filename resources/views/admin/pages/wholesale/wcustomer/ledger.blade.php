            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form name="form" method="post" action="{{route('admin.wcustomerpayment.store')}}">
                            @csrf
...
{{--                                </div>--}}
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="text-center pb-3 mt-4">Wcustomer Ledger</h2>
                    <div class="card">
                                ...
                                <table class="table table-centered table-borderless table-hover mb-0"
                                    ...
                                    @forelse ($orders as $order)
                                        ...
                                        <tr class="">
                                            ...
                                            <td></td>
                                            <td>
                                                {{App\Models\User::where('id',$order->admin_id)->first()->name}}
                                            </td>
                                        </tr>
                                        ...
                                        @forelse(App\Models\Wpayment::where('wsale_id',$order->id)->get() as $payment)
                                            ...
                                            <tr class="">
                                                ...
                                                <td>{{ $payment->payment_type }}
                                                    Receive For- #{{ $order->invoiceID }}</td>
                                                <td>{{ $payment->amount }}</td>
                                                <td></td>
                                                <td>{{ $due }}</td>
                                                <td></td>
                                                <td>
                                                    {{App\Models\User::where('id',$payment->admin_id)->first()->name}}
                                                </td>
                                            </tr>
