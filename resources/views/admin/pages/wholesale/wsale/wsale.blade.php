    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="pagetitle row">
            ...
            <div class="col-6" style="text-align: right">
                @can('Create Wholesale')
                    <a href="{{ route('admin.wsales.create') }}" class="btn btn-primary btn-sm"><span
                    ...
                    <div class="card">
                        <div class="card-body pt-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-borderless table-hover mb-0" id="wsaleinfotbl"
                                       width="100%">
