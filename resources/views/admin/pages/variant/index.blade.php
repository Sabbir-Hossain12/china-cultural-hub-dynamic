        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Variant</h5>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            let adminTable = $('#adminTable').DataTable({
                ...
                serverSide: true,
                {{--ajax: "{{url('/admin/data')}}",--}}
                ajax: "{{route('admin.variant.index')}}",
                // pageLength: 30,
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ url('admin/variants') }}/" + id + "/edit",
                        data: {
                            id: id
                        },
            ...
            $(document).on('click', '#adminStatus', function () {
                ...
                $.ajax(
                    {
                        type: 'post',
                        url: "{{route('admin.variant.status')}}",
                        data: {
                            '_token': token,
                            id: id,
                            status: status
